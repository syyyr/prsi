...
export default class Player extends React.Component<PlayerProps> {
    render(): React.ReactNode {
        const playerInfoRender =
            ...
            : typeof this.props.place !== "undefined" ? React.createElement(PlaceComponent, {key: `${this.props.name}:place`, place: this.props.place})
            : undefined;
